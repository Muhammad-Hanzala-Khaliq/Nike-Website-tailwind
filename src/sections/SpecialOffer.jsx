  ...
  return (
   ...
   <img src={offer} alt="" width={773} height={687} className='object-contain w-full'/>
      ...
      <h2 className='font-palanquin text-4xl capitalize font-bold lg:max-w-lg dark:text-white'>
        ...
        <p className='mt-4 lg:max-w-lg info-text'>Embark on a shopping journey that redefines your experience with unbeatable deals.From premier selections to incredible savings we offer unparalleled value that sets up apart</p>
